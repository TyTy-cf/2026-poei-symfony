 ...
 */
final class Version20260708131849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(80) NOT NULL, image VARCHAR(255) DEFAULT NULL, slug VARCHAR(80) NOT NULL, UNIQUE INDEX UNIQ_64C19C15E237E06 (name), UNIQUE INDEX UNIQ_64C19C1989D9B62 (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE country (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(5) NOT NULL, name VARCHAR(255) NOT NULL, nationality VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, url_flag VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_5373C96677153098 (code), UNIQUE INDEX UNIQ_5373C9665E237E06 (name), UNIQUE INDEX UNIQ_5373C966989D9B62 (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, price INT NOT NULL, description LONGTEXT DEFAULT NULL, published_at DATETIME NOT NULL, thumbnail_cover VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, publisher_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_232B318C5E237E06 (name), UNIQUE INDEX UNIQ_232B318C989D9B62 (slug), INDEX IDX_232B318C40C86FCE (publisher_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('CREATE TABLE game_category (game_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_AD08E6E7E48FD905 (game_id), INDEX IDX_AD08E6E712469DE2 (category_id), PRIMARY KEY (game_id, category_id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE publisher (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, website VARCHAR(255) NOT NULL, country_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_9CE8D5465E237E06 (name), UNIQUE INDEX UNIQ_9CE8D546989D9B62 (slug), INDEX IDX_9CE8D546F92F3E70 (country_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, downvote INT NOT NULL, upvote INT NOT NULL, rating INT NOT NULL, user_id INT NOT NULL, game_id INT NOT NULL, INDEX IDX_794381C6A76ED395 (user_id), INDEX IDX_794381C6E48FD905 (game_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, name VARCHAR(255) NOT NULL, nickname VARCHAR(255) NOT NULL, profile_image VARCHAR(255) DEFAULT NULL, wallet INT DEFAULT 0 NOT NULL, country_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D6495E237E06 (name), INDEX IDX_8D93D649F92F3E70 (country_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE user_own_game (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, game_time INT NOT NULL, last_used_at DATETIME DEFAULT NULL, is_installed TINYINT NOT NULL, game_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_2F79BF7BE48FD905 (game_id), INDEX IDX_2F79BF7BA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
